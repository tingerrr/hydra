...
#let hydra(
  ...
  /// -> bool
  use-last: false,
  /// The reading direction of the document. If this is #typ.v.auto, the text
  /// direction is used. Be cautious about leaving this option on #typ.v.auto
  /// if you switch text direction mid-page and use @cmd:hydra outside of
  /// footers or headers.
  ///
  /// -> direction | auto
  dir: auto,
  /// The binding of the document. If this is #typ.v.auto, the binding is
  /// inferred from @cmd:hydra.dir, similar to how it is done in page. Be
  /// cautious about leaving this on option on #typ.v.auto if you switch text
  /// direction mid-page and use @cmd:hydra outside of footers or headers.
  ///
  /// -> alignment | auto
  binding: auto,
  ...
  /// when an element is visible on the previous page. Make sure to set
  /// @cmd:hydra.binding and @cmd:hydra.dir if the document is not using
